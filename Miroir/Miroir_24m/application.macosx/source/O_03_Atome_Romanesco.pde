...
////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////COVALENT COLLISION//////////////////////////////////////////////////
  void covalentCollision(ArrayList<Atom> listA ) // external
  {
    for (Atom target : listA) {
  ...
  void contactCovalentEN(Atom target, PVector atomVect)  // internal
  {
  ...
  //::::::::::::
  void statementCovalent(Atom target) // internal
  {
...
//:::::::::::::::::::::::the result depend of the positiv or negativ atom load.
  void electronicCollision(ArrayList<Atom> listA, boolean ionicEffect ) // external
  {
    for (Atom target : listA) {
      if(ionicEffect) {
  ...
  void contactElectronic(Atom target)  // internal
  {
...
//////////////////////RESOLVE COLLISION/////////////////////////////////
  void resolveCollision(Atom target , PVector atomVect) // internal 
  {
...
//::::::::::::::::::::::::::ELECTRON::::::::::::::::::::::::::::::::::::::::::::::
  ...
  void electronicInfo() // internal & external
  {
 ...
 /////////////////////DISPLAY PROPERTY of ATOM////////////////////////////////////////////
  void titleAtom2D (color cName, color cInfo, PFont p, int sizeTextName, int sizeTextInfo, float amp_ ) {
    ...
    if ( alpha(cInfo) != 0 ) {
      ...
      miroir.text(valenceElectron,  pos.x +posXtext , pos.y +( 2.3 *posYtext));
     ...
     // miroir.text(proton,           pos.x -posXtext , pos.y +sizeTextInfo); 
      miroir.text(proton,           pos.x -posXtext , pos.y +( 2.3 *posYtext));
